  ...
  return (
    <div className="w-full h-screen flex justify-center items-center p-4">
      <form method="POST" action="https://getform.io/f/0374e9fe-8514-4a93-9c86-556b05d27e43" className="flex flex-col max-w-[600px] w-full">
        ...
        <input className="border-2 border-black p-2" type="text" placeholder="Name" name="name" required />
        <input className="border-2 border-black my-4 p-2" type="email" placeholder="Email" name="email" required />
        <textarea className="border-2 border-black p-2" placeholder="Message" name="message" rows="10" required></textarea>
